...
public void GioiThieu(){
    CachChoi.setText("\t\t TRÒ CHƠI");
    CachChoi.setText(CachChoi.getText()+" \n    Ván cờ được chơi trên bàn cờ 16x16 ô vuông. "
            + "Hai bên sẽ thay phiên nhau tích vào những ô vuông trên bàn cờ. Ký hiệu mỗi nước đi của từng người là X hoặc O.");
     CachChoi.setText(CachChoi.getText()+" \n   Người Chơi sẽ phải dùng chiến thuật và kinh nghiệm tạo thành 1 hàng ngang , dọc , chéo , có 5 quân. "
            + "Lưu ý là 5 quân cờ này không được phép chặn hai đầu.");

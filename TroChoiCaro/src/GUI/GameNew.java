 ...
 */
public class GameNew extends javax.swing.JFrame {
 private int row =20;
    private int col = 20;
    ...
    public GameNew() {
        ...
        this.setIconImage(new ImageIcon("./src/Photo//unnamed.png").getImage());
        this.setResizable(false);
...
//        jLabel19.setIcon(new ImageIcon("assets/game/"+Client.user.getAvatar()+".jpg"));
        ...
        jLabel5.setIcon(new ImageIcon("./src/Photo//icons8_round_24px.png"));
        jButton3.setIcon(new ImageIcon("/Photo//unnamed.png"));
...
//                        handleClickButton(point);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameNew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
